...
<!DOCTYPE html>
        ...
        <div class="home-slider ">
            <div class="main-slider my-3 ">
                <div class="main-slider-item"><img class="rounded-2 " src="img/banner.png" alt="Slider Image" /></div>
                <div class="main-slider-item"><img class="rounded-2 " src="img/banner2.jpg" alt="Slider Image" /></div>
                <div class="main-slider-item"><img class="rounded-2 " src="img/banner3.jpg" alt="Slider Image" /></div>
            </div>
        </div>
        <!-- Main Slider End -->
